...
const dummyClients = [
  {
    ...
    isVip: true,
    orders: [
      { id: "#32845", dateTime: "14.04.2025", status: "В работе", amount: 2500 },
      { id: "#31792", dateTime: "03.02.2025", status: "Завершен", amount: 1800 },
      { id: "#30487", dateTime: "15.11.2024", status: "Завершен", amount: 3200 },
      { id: "#29654", dateTime: "28.07.2024", status: "Завершен", amount: 2100 },
      { id: "#32841", dateTime: "12.04.2024", status: "Завершен", amount: 1900 },
    ],
  },
  {
    id: "2",
    ...
    isVip: false,
    orders: [
      { id: "#32846", dateTime: "14.04, 17:00", status: "Ожидает", amount: 3200 },
      { id: "#32840", dateTime: "11.04, 15:30", status: "Завершен", amount: 2800 },
    ],
  },
  {
    id: "3",
    ...
    isVip: false,
    orders: [{ id: "#32844", dateTime: "14.04, 09:30", status: "Завершен", amount: 1800 }],
  },
  {
    id: "4",
    name: "Михаил Аварбух",
    ...
    isVip: true,
    orders: [{ id: "#32843", dateTime: "13.04, 16:00", status: "Завершен", amount: 2100 }],
  },
  {
    id: "5",
    name: "Сара Бергер",
    ...
    isVip: false,
    orders: [{ id: "#32842", dateTime: "13.04, 10:00", status: "Завершен", amount: 4200 }],
  },
]
...
export function ClientCard({ clientId, language, onBack }: ClientCardProps) {
  ...
  if (!client) {
    return (
      <div className="p-6">
        <p className="text-gray-600">{language === "ru" ? "Клиент не найден" : "Client not found"}</p>
      </div>
    )
  }
    ...
    <div className="h-full flex flex-col">
      <div className="p-4 lg:p-6 space-y-6">
        <div className="flex flex-col justify-start items-start gap-4 mb-6">
          ...
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">{t("clientCard")}</h1>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg shadow p-6">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            ...
            <Button onClick={handleEdit} className="bg-blue-400 hover:bg-blue-700 flex items-center rounded-full gap-2">
